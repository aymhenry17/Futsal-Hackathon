                ...
                <div className="relative z-10 container mx-auto px-6 h-full flex items-center">
                    <div className="max-w-3xl text-center mx-auto">
                        ...
                        <p className="text-xl text-white mb-8 drop-shadow-md">
                            Offrir une chance à chaque jeune de trouver sa voie
                            grâce à l'accompagnement de bénévoles passionnés.
                        </p>
                        <a
                            href="#programmes"
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 leading-relaxed mb-6">
                                L'Académie de l'Avenir accompagne les jeunes en
                                difficulté dans leur insertion professionnelle.
                                Nous croyons en la force du collectif et en
                                l'impact des bénévoles pour transformer des
                                vies.
                            </p>
                            <ul className="space-y-6">
                                <li className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Un suivi sur mesure pour construire
                                ...
                                <li className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Des professionnels dévoués pour
                                            guider et inspirer.
                                        </p>
                                    </div>
                                </li>
            ...
            <section className="py-20 bg-blue-600">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
                        Vous êtes un jeune à la recherche de votre voie ? Vous
                        souhaitez devenir bénévole et accompagner des jeunes ?
