...
import { Users, Heart, ShoppingBag, Calendar, MapPin, Clock, FileText } from "lucide-react";
  ...
  const initiatives = [
    {
      ...
      description: "Distribution hebdomadaire de paniers alimentaires aux familles dans le besoin.",
      details: [
    ...
    },
    {
      ...
      description: "Projet de rénovation de logements pour les familles en difficulté.",
      details: [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-center">
          <div className="max-w-3xl text-center mx-auto">
            ...
            <p className="text-xl text-white mb-8 drop-shadow-md">
              Ensemble, nous faisons bouger les choses. Soyez acteur de la solidarité !
            </p>
            <a
              href="#initiatives"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Notre association s'engage à accompagner les familles en difficulté, à créer des liens 
                de solidarité et à apporter un soutien concret aux personnes les plus vulnérables.
              </p>
              <ul className="space-y-6">
                <li className="flex items-start">
                  <Heart className="w-8 h-8 text-blue-600 mr-4" />
                  <div>
                    <h3 className="font-bold text-lg mb-1">Soutien Personnalisé</h3>
                    <p className="text-gray-600">
                      Un accompagnement adapté aux besoins de chaque famille.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Réseau de Solidarité</h3>
                    <p className="text-gray-600">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Actions Concrètes</h3>
                    <p className="text-gray-600">
                      Distribution alimentaire, aide au logement et soutien administratif.
                    </p>
                  </div>
                </li>
              </ul>
      ...
      <section id="initiatives" className="py-20 bg-gray-100">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center">Nos Initiatives</h2>
          <div className="grid md:grid-cols-3 gap-12">
            {initiatives.map((initiative, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4">{initiative.titre}</h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold mb-12 text-center">Nos Événements à Venir</h2>
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mt-1 mb-2">{event.titre}</h3>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Vous souhaitez contribuer à notre mission, devenir bénévole ou simplement en savoir plus ?
            Contactez-nous et faisons ensemble la différence.
          </p>
          <a
            href="/contact"
